...
| Ask a question about the brain over Telegram | `tools/brain-bot/` | read-only agentic-retrieval Q&A bot; long-poll listener + headless Claude over the repo; cites file paths; setup in its `README.md` |
